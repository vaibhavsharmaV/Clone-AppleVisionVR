...
gsap.to("#page>video",{
  scrollTrigger:{
      ...
      scroller:`#main`
      /* yha start aur end, m phli property element ki hai, dusri screen ki hai,
      mtlb. jsa yha 2% element jab screen ka top se touch hoga tab trigger hogi video
      2% element hai top screen; asa hi end m:- bottom element hai aur top screen,
      jab element ka bottom screen ka top se touch hoga tab animation end ho jyagi  */ 
  },
  onStart:()=>{
...
gsap.to("#page",{
  scrollTrigger:{
    ...
    scroller:`#main`,
    pin:true
     /* Pin True se hmara page fix ho gya jab tak animation ni chal jti
    phla animation chlagi phir page bdaga necha ya scroll hoga*/
  }
})
...
gsap.to("#page-bottom",{
  scrollTrigger:{
    trigger:`#page-bottom`,
    start:`5% top`,
    /*jab 5% element ka screen ka top ka upr jyaga tab trigger hoga page-bottom
    gayab hona, kyuki opacity di hai na 0. */
    end:`bottom top`,
    scroller:`#main`,
  },
  opacity:0
...
var t1 = gsap.timeline({
  scrollTrigger:{
    trigger:`#page1`,
    start:`top top`,
    /* yha screen ka top aur element ka top diya hua hai, jab screen ka top p element 
    ka top lagaga toh start hogi animation*/
    scrub:1,
    /*if u scrub:1 then, this happen :- The animation's progress is directly tied to the 
    scroll position. If you scroll 10% of the way down, the animation will be 10% complete. 
    If you scroll 50% of the way down, the animation will be 50% complete. It synchronizes 
    with the scroll position in a one-to-one relationship*/
    scroller:`#main`,
    pin:true
  }
})
